...
<template>
	<div class="container">
		...
		<vueSeamless :data="listData" class="warp">
			<ul class="item">
				<li class="itemli" v-for="(item, index) in listData" :key="index">
					<span class="name" v-text="item.name"></span>
					<span class="name" v-text="item.stack"></span>
					<span class="brand" v-text="item.category"></span>
					<span class="category" v-text="item.num"></span>
				</li>
			</ul>
		</vueSeamless>
	</div>
